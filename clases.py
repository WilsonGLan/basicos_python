...
class Canal(Television):  # Entre parentesis agregamos la clase de la cual hereda
    ...
    def mostrar(self):
        print("A continuación sigue el programa", self.programa, "en la franja de ", self.categoria, "genero ",
              self.genero)
...
class Television(object):
    def __init__(self, programa, categoria, genero,
                 productora):  # Definicion de atributos en el constructor de la clase padre
...
class Canal(Television):  # Clase Canal hereda de Television
    ...
    def __init__(self, programa, categoria, genero, productora, nombre_canal):  # constructor de la clase Canal
        super().__init__(programa, categoria, genero,
                         productora)  # Con super llamamos a los atributos de la clase padre
...
# =========================================================================================
# Funciones como el input de otra función.
...
result = calculator(8, 5, multiply) #como tercer parametro llamo a la función que necesito para hacer la operacion
print(result)